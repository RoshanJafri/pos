                    ...
                    <div class="card-body order-details-container">
                        ...
                        <div class="mt-3 border-top pt-3 order-summary-container d-none">
                            ...
                            <div class="border p-3">
                                ...
                                <hr>
                                @if (session('sales_authenticated') || session('orders_authenticated'))
                                    <label for="created_at" class="label">Order Date &amp; Time</label>
                                    <br>
                                    <small class="text-primary">Select date this order was made at</small>
                            ...
                            <div>
                                <form id="orderDetailsForm" action="{{ route('orders.store') }}" method="POST">
                                    @csrf
                                </form>
                            </div>
                        </div>
...
@push('scripts')
    ...
    <script>
        ...
        function calculate() {
            ...
            console.log('discount percentage should be ' + (discountPercentage / 100) + '. So new discount should be ' +
                subtotal + ' * ' + (discountPercentage / 100) + ' = ' + discount);
